<template>
  <section class="bg-slate-200">
    <div class="container max-w-6xl ml-auto mb-24 px-4 pt-9 lg:px-8">
      ...
      >
        <swiper-slide v-for="product in bestsallersProducts" :key="product.id">
          <GlobalProductItem :product="product" class="w-72 h-full md:w-full" />
        </swiper-slide>
      </swiper>

      <div class="block pb-20 text-center sm:hidden">
